...
func PrintUsage() {
	...
	fmt.Println(string(Yellow) + "  go run cmd/main.go <network_map> <start_station> <end_station> <number_of_trains>" + string(Reset))
	fmt.Println()
	...
	fmt.Println(string(Yellow) + "     go run cmd/main.go network.map waterloo st_pancras 4" + string(Reset))
	fmt.Println()
	...
	fmt.Println(string(Cyan) + "  1. Navigate to the project root directory" + string(Reset))
	fmt.Println(string(Cyan) + "  2. Run the following command:" + string(Reset))
	fmt.Println(string(Yellow) + "     go run cmd/main.go -v network.map waterloo st_pancras 4" + string(Reset))
	fmt.Println()
